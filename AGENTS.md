...
make dev AGENT=cursor_sdk               # 或 AGENT=hermes | engine
```
...
- [docs/architecture.md](docs/architecture.md) — 架构、Design Turn、Legacy API
- [docs/design-pipeline.md](docs/design-pipeline.md) — 流水线细节
- [docs/agents/README.md](docs/agents/README.md) — Web 对话接入
